...
input_file_src="grc-lat.test.grc.vec"
input_file_tgt="grc-lat.test.lat.vec"

#adjust input files here
se = KeyedVectors.load_word2vec_format(input_file_src, binary=0, encoding='utf-8', unicode_errors='replace', limit=None)
te = KeyedVectors.load_word2vec_format(input_file_tgt, binary=0, encoding='utf-8', unicode_errors='replace', limit=None)
