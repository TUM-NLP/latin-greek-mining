...
if word_level_model:
    ...
    word_embedding_model = models.Transformer(model_name, max_seq_length=450, config_args={"output_hidden_states": True})
...
import math
steps_per_epoch = math.ceil(len(train_dataset["train"]) / batch_size)
